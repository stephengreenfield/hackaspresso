...
const float readingWithNothing = 8644377; // Nothing meaning the weight of the apparatus and scoopoer or whatever.
const float readingWith3SeltzerCans = 9059920;
